                    ...
                    <div className="col-lg-4 mb-2">
                        <div className="card border-1 rounded rounded-3 card-hover">
                            <div className="card-body">
                                ...
                                <hr/>
                                <p className="card-text">
                                    <Link to="/admin/users" className="btn btn-sm btn-primary w-100">Browse</Link>
                                </p>
                                <p className="card-text">
                                    <Link to="/admin/users/roles" className="btn btn-sm btn-primary w-100">Browse roles</Link>
                                </p>
                            </div>
                        </div>
                    </div>
